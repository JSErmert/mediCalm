...
4. `11_mediCalm_references_source_mapping.md`  
5. `03_mediCalm_knowledge_protocol_doctrine.md`  
6. `04_mediCalm_execution_spec.md`  
7. `05_mediCalm_guided_session_ui_spec.md`  
8. `06_mediCalm_safety_reassurance_spec.md`  
9. `07_mediCalm_visual_design_doctrine.md`  
10. `08_mediCalm_master_architecture.md`  
11. `09_mediCalm_glossary.md`  
12. `10_mediCalm_open_questions_and_validation.md`  
...
18. `17_mediCalm_accessibility_-motion_fallbacks.md`  
19. `19_mechanism_protocol_mapping.md`
  
## Authority by Domain  
  
### Product Identity  
1. `01_mediCalm_product_vision.md`  
2. `08_mediCalm_master_architecture.md`  
3. `12_mediCalm_ux_ui_experience_report.md`  
  
### Source Truth and Claims Boundaries  
1. `11_mediCalm_references_source_mapping.md`  
2. `02_mediCalm_source_truth_doctrine.md`  
3. `06_mediCalm_safety_reassurance_spec.md`  
  
### Mechanism and Protocol Concepts  
1. `03_mediCalm_knowledge_protocol_doctrine.md`  
2. `13_mediCalm_protocol_library.md`  
3. `19_mechanism_protocol_mapping.md`
4. `14_mediCalm_input_taxonomy.md`  
  
### Runtime Behavior  
1. `04_mediCalm_execution_spec.md`  
2. `08_mediCalm_master_architecture.md`  
3. `03_mediCalm_knowledge_protocol_doctrine.md`  
  
### Guided Session Presentation  
1. `05_mediCalm_guided_session_ui_spec.md`  
2. `12_mediCalm_ux_ui_experience_report.md`  
3. `07_mediCalm_visual_design_doctrine.md`  
  
### Safety, Reassurance, and Escalation  
1. `06_mediCalm_safety_reassurance_spec.md`  
2. `11_mediCalm_references_source_mapping.md`  
3. `02_mediCalm_source_truth_doctrine.md`  
  
### Visual System  
1. `07_mediCalm_visual_design_doctrine.md`  
2. `05_mediCalm_guided_session_ui_spec.md`  
3. `12_mediCalm_ux_ui_experience_report.md`  
  
### Data and Persistence  
1. `15_mediCalm_data_schema.md`  
2. `04_mediCalm_execution_spec.md`  
3. `08_mediCalm_master_architecture.md`  
  
### Language and Copy  
1. `16_mediCalm_copy_system.md`  
2. `06_mediCalm_safety_reassurance_spec.md`  
3. `12_mediCalm_ux_ui_experience_report.md`  
4. `09_mediCalm_glossary.md`  
  
### Accessibility and Motion Alternatives  
1. `17_mediCalm_accessibility_-motion_fallbacks.md`  
2. `05_mediCalm_guided_session_ui_spec.md`  
3. `07_mediCalm_visual_design_doctrine.md`  
